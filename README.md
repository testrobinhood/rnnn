...
(Take 1st Cable)
1)PC0→Desktop→IP Config→IP Address=192.168.0.1  
2)PC1→Desktop→IP Config→IP Address=192.168.0.2 <br> 
3)PC2→Desktop→IP Config→IP Address=192.168.0.3 <br> 
4)PC3→Desktop→IP Config→IP Address=192.168.0.4 <br> 
